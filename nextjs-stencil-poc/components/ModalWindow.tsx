    ...
    const DecoratedComponent = {
        ...
        props: {
            ...
            dangerouslySetInnerHTML: {
                __html: `<!--r.1--><div class=\"wrapper sc-modal-window\" c-id=\"1.0.0.0\"><div class=\"backdrop sc-modal-window show\" c-id=\"1.1.1.0\"></div><div class=\"modal sc-modal-window\" c-id=\"1.2.1.1\"><header class=\"sc-modal-window\" c-id=\"1.3.2.0\"><button class=\"sc-modal-window\" c-id=\"1.5.3.1\"><!--t.1.6.4.0-->X</button></header><main class=\"sc-modal-window sc-modal-window-s\" c-id=\"1.7.2.1\"></main></div></div>`
            }
        },
        ref: trackedRef
    }
