...
const SubMenu = (analyticsAction) => ({ listItems, subMenuTitle, isCapitalized }) => hAsync("div", { class: 'sub-menu' },
  hAsync("div", { class: 'sub-menu-inner' },
    ...
    hAsync("ul", { class: 'sub-menu-list' },
      hAsync(AnchorList, { listItems: listItems, analyticsAction: analyticsAction, className: isCapitalized ? 'sub-menu-list-item--capitalized' : '' }))));
