...
const SubMenuIndustry = () => hAsync("div", { class: 'sub-menu' },
  "Per branche",
  hAsync("ul", null,
    hAsync("li", null,
      hAsync("a", { href: "" }, "Bouw")),
...
const SubMenuCity = () => hAsync("div", { class: 'sub-menu' },
  "Per plaats",
  hAsync("ul", null,
    hAsync("li", null,
      hAsync("a", { href: "" }, "Amsterdam")),
    hAsync("li", null,
      hAsync("a", { href: "" }, "Den Haag"))));
...
const DropdownContainerJobs = () => hAsync("div", { class: "dropdown-container" },
  hAsync("ul", { class: 'dropdown-list' },
    ...
    hAsync("li", { class: 'sub-menu-container' },
      ...
      hAsync(SubMenuIndustry, null)),
    hAsync("li", { class: 'sub-menu-container' },
      hAsync("button", { class: 'sub-menu-link' }, "per plaats"),
      hAsync(SubMenuCity, null))));
