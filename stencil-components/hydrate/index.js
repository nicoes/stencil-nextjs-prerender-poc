...
const mobileMenuCss = "/*!@.wrapper*/.wrapper.sc-mobile-menu{position:fixed;left:0;top:0;width:100%;height:100%;visibility:hidden;z-index:2000}/*!@.backdrop*/.backdrop.sc-mobile-menu{position:absolute;left:0;top:0;width:100%;height:100%;background-color:rgba(0, 0, 0, 0.8);opacity:0;transition:visibility 0.3s, opacity 0.3s 0s;z-index:1}/*!@.visible*/.visible.sc-mobile-menu{visibility:visible}/*!@.visible .backdrop*/.visible.sc-mobile-menu .backdrop.sc-mobile-menu{opacity:1}/*!@.mobile-menu*/.mobile-menu.sc-mobile-menu{font-size:14px;padding:10px 10px 5px 10px;background-color:#fff;position:absolute;top:0;right:0;border-radius:2px;min-width:300px;height:100%;z-index:2;transform:translateX(100%);transition:visibility 0.3s, transform 0.3s ease-out}/*!@.visible .mobile-menu*/.visible.sc-mobile-menu .mobile-menu.sc-mobile-menu{transform:translateX(0)}/*!@h1*/h1.sc-mobile-menu{font-size:18px}/*!@header*/header.sc-mobile-menu{display:flex;justify-content:space-between}/*!@button*/button.sc-mobile-menu{margin-left:5px;min-width:80px;background-color:#848e97;border-color:#848e97;border-style:solid;border-radius:2px;padding:3px;color:white;cursor:pointer}/*!@button:hover*/button.sc-mobile-menu:hover{background-color:#6c757d;border-color:#6c757d}";
...
class MobileMenu {
  ...
  render() {
    return (hAsync("div", { class: this.isVisible ? 'wrapper visible' : 'wrapper' }, hAsync("div", { class: 'backdrop', onClick: () => this.handleModalClose() }), hAsync("div", { class: "mobile-menu" }, hAsync("header", null, "Mobile menu", hAsync("button", { onClick: () => this.handleModalClose() }, "X")))));
  }
  static get watchers() { return {
    "isVisible": ["onNameChanged"]
  }; }
  static get style() { return mobileMenuCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "mobile-menu",
    "$members$": {
...
const SubMenu = ({ listItems }) => hAsync("div", { class: 'sub-menu' },
  hAsync("div", { class: 'sub-menu-inner' },
    hAsync("strong", { class: 'sub-menu-title' }, "Per plaats"),
...
const DropdownContainerJobs = () => hAsync("div", { class: "dropdown-container" },
  hAsync("ul", { class: 'dropdown-list' },
    ...
    hAsync("li", { class: 'sub-menu-container' },
      ...
      hAsync(SubMenu, { listItems: industryListItems })),
    hAsync("li", { class: 'sub-menu-container' },
      hAsync("button", { class: 'sub-menu-link' }, "per plaats"),
      hAsync(SubMenu, { listItems: cityListItems })),
