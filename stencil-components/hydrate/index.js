...
const TopBar = () => hAsync("div", { class: 'top' },
  hAsync("ul", { class: 'top-list' },
    hAsync("li", null,
      hAsync("a", Object.assign({ href: "/werkgever" }, AnalyticsDataAttributes$1({ action: 'ClickOnHeaderAccountLink', label: 'Inloggen' })),
        hAsync(ProfileIcon, { className: 'profile-icon' }),
        "Inloggen")),
    hAsync("li", null,
      hAsync("a", Object.assign({ href: "/werkgever" }, AnalyticsDataAttributes$1({ action: 'ClickOnHeaderProfileLink', label: 'Adverteren' })), "Profiel maken")),
    hAsync("li", null,
      hAsync("a", Object.assign({ href: "/werkgever" }, AnalyticsDataAttributes$1({ action: 'ClickOnHeaderLink', label: 'Registreren' })), "Adverteren"))),
...
const MobileMenuAccountAuthenticated$3 = () => hAsync("ul", { class: 'mobile-menu__link-list' },
  hAsync("li", null,
    hAsync("a", Object.assign({}, AnalyticsDataAttributes({ action: 'ClickOnHeaderProfileLink', label: 'JouwProfiel' }), { class: 'mobile-menu__link--with-icon', href: '/profiel/overzicht' }), "Profiel")));

const MobileMenuAccountAuthenticated$2 = () => hAsync("ul", { class: 'mobile-menu__link-list' },
  hAsync("li", null,
