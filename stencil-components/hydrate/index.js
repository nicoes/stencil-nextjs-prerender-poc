...
const MobileMenuIcon = (path) => () => hAsync("svg", { class: 'mobile-menu__link-icon', width: "24", height: "24", fill: "#323232", xmlns: "http://www.w3.org/2000/svg" }, path());
const Icons = {
  'campaign': MobileMenuIcon(paths.campaign),
  'search': MobileMenuIcon(paths.search),
  'euro': MobileMenuIcon(paths.euro),
  'lightbulb': MobileMenuIcon(paths.lightbulb),
  'person': MobileMenuIcon(paths.person),
  'mail': MobileMenuIcon(paths.mail),
  'favorite': MobileMenuIcon(paths.favorite),
  'settings': MobileMenuIcon(paths.settings),
};
...
class NvbHeaderB2c {
  ...
  render() {
    return (hAsync("header", null, hAsync("div", { class: "container container--top" }, hAsync("div", { class: 'top' }, hAsync("a", { href: "#" }, "Werkgevers / Plaats vacature"))), hAsync("nav", { class: 'main' }, hAsync("div", { class: "container" }, hAsync("div", { class: "main-inner" }, hAsync("a", { href: "#", class: 'logo-link' }, hAsync(Logo, null)), hAsync("div", { class: 'menu' }, hAsync("div", { class: "dropdown-wrapper" }, hAsync("button", { class: 'menu-link menu-link--dropdown' }, "Vacatures"), hAsync(DropdownContainerJobs, null)), hAsync("div", { class: 'dropdown-wrapper' }, hAsync("button", { class: 'menu-link menu-link--dropdown' }, "Carri\u00E8retips"), hAsync(DropdownContainerCareer$1, null)), hAsync("a", { href: "/salariswijzer", class: 'menu-link' }, "Salariswijzer"), hAsync("hr", { class: 'menu-separator' }), hAsync("div", { class: 'dropdown-wrapper' }, hAsync("button", { class: 'menu-link menu-link--dropdown' }, "Account"), hAsync(DropdownContainerCareer, null)), hAsync("div", { class: "dropdown-backdrop" })), hAsync("div", { class: 'mobile-menu-container' }, hAsync("button", { onClick: () => this.isActiveMobileMenu = !this.isActiveMobileMenu }, "Mobile menu"))))), this.isClientSide && hAsync(MobileMenu, { isVisible: this.isActiveMobileMenu, handleModalClose: () => this.handleClose(), activeMobileMenuLevel: this.activeMobileMenuLevel, setActiveMobileMenuLevel: level => this.setActiveMobileMenuLevel(level) })));
  }
  static get watchers() { return {
