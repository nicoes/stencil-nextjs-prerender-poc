      ...
      hAsync("div", { class: "mobile-menu__stack" },
        hAsync("div", { class: "mobile-menu__stack-inner" + stackInnerModifier },
          ...
          hAsync("section", { class: "mobile-menu__stack-screen" },
            ...
            activeMobileMenuLevel === 'career' && hAsync("div", null,
              hAsync("div", { class: 'mobile-menu__link-list-title' }, "Carri\u00E8retips"),
              hAsync("ul", { class: 'mobile-menu__link-list' },
                hAsync("li", null,
                  hAsync("a", { class: "mobile-menu__link--no-icon", href: "" }, "Alle")),
                hAsync("li", null,
                  hAsync("a", { class: "mobile-menu__link--no-icon", href: "" }, "Actueel"))))),
          hAsync("section", { class: "mobile-menu__stack-screen" },
            activeMobileMenuLevel === 'cities' && hAsync("div", null,
