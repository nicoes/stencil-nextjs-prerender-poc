...
const SubMenu = ({ listItems }) => hAsync("div", { class: 'sub-menu-wrapper' },
  hAsync("div", { class: 'sub-menu-placeholder-list' }, Array(calculatePlaceholderListLength(listItems)).fill(null).map(() => hAsync("span", { class: 'sub-menu-placeholder-item' }))),
  hAsync("div", { class: 'sub-menu' },
