...
const DropdownContainerCareer = () => hAsync("div", { class: "dropdown-container" },
  hAsync("div", { class: "container" },
    hAsync("ul", { class: 'dropdown-list' },
      hAsync("li", null,
        hAsync("a", Object.assign({}, AnalyticsDataAttributes({ action: 'ClickOnHeaderWerkZoekendenLink', label: "Zoekopdrachten" }), { href: "/vacature/zoeken/zoekopdrachten-beheren" }), "Zoekopdrachten")),
      hAsync("li", null,
        hAsync("a", Object.assign({}, AnalyticsDataAttributes({ action: 'ClickOnHeaderWerkZoekendenLink', label: "Favorieten" }), { href: "/vacature/zoeken/favorieten" }), "Favorieten")),
      hAsync("li", null,
...
const MobileMainMenu = ({ setActiveMobileMenuLevel }) => hAsync("div", null,
...
const MobileMenu = ({ isVisible, handleModalClose, activeMobileMenuLevel, setActiveMobileMenuLevel }) => {
      ...
      hAsync("div", { class: "mobile-menu__stack" },
        hAsync("div", { class: "mobile-menu__stack-inner" + stackInnerModifier },
          hAsync("section", { class: "mobile-menu__stack-screen" },
            hAsync(MobileMainMenu, { setActiveMobileMenuLevel: setActiveMobileMenuLevel })),
          hAsync("section", { class: "mobile-menu__stack-screen" },
