...
const DropdownContainer = ({ listItems, analyticsAction }) => hAsync("menu", { class: 'dropdown-list' },
...
class IolHeaderB2c {
  ...
  render() {
    ...
    return (hAsync("header", null, hAsync("div", { class: "container container--top" }, hAsync(TopBar, null)), hAsync("nav", { class: 'main' }, hAsync("div", { class: "container" }, hAsync("div", { class: "main-inner" }, hAsync("div", { class: "mobile-menu-button-container" }, hAsync("button", { class: "mobile-menu-button", onClick: () => this.handleOpenMenu(), "aria-label": "Open menu" }, hAsync(Icons$1.menu, { className: 'mobile-menu__header-icon' }))), hAsync("div", { class: 'menu' }, hAsync("div", { class: dropdownActiveClassExtender('/vacature') }, hAsync("button", { class: 'menu-link menu-link--dropdown' }, "Vacatures"), hAsync(DropdownContainer, { listItems: jobsListItems$1, analyticsAction: 'ClickOnHeaderWerkZoekendenLink' })), hAsync("div", { class: dropdownActiveClassExtender('/werk-en-carriere') }, hAsync("button", { class: 'menu-link menu-link--dropdown' }, "Topics"), hAsync(DropdownContainer, { listItems: topicsListItems, analyticsAction: 'ClickOnHeaderTopicsLink' }))))))));
  }
